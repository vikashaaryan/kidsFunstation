       ...
       <?php include_once "includes/sidebar.php";?>
        <div class="w-9/12">
            <div class="m-10 flex justify-between items-center">
                <h2 class="text-3xl font-semibold">Realtime Session(5)</h2>
                <div class="flex gap-4">
                    ...
                    <a href="#" class="flex items-center gap-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold text-lg rounded-lg py-2 px-4 shadow-md">
            ...
            <div class="grid grid-cols-3 gap-4 p-10">
                <div class="border border-3 bg-green-100 text-sm rounded p-4 flex flex-col gap-3">
                    <h2 class="font-semibold  text-gray-600">Viaksh kumar</h2>
                    ...
                    <p class="text-gray-600 ">
                        Time Left <span class="text-gray-800 font-semibold">0h 58m 8s</span>
                    </p>
